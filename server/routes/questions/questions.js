var questions = {
  getQuestions({ req, res, dir, headers, query }, { ToJSON, CSV, XML, YAML }) {
    if (req.method === "GET") {
      switch (req.url) {
  ...
  postQuestions({ req, res, dir, headers }, { ToJSON, CSV, XML, YAML }) {
  ...
  deleteQuestions({ req, res, dir, headers }, { ToJSON, CSV, XML, YAML }) {
